...
alias   updateDots="cd; cp .zshrc ~/Documents/dots; cp .vimrc ~/Documents/dots; cp .tmux.conf ~/Documents/dots; cd Documents/dots; git add .; git commit -m 'updated automatically'; git push; cd"
